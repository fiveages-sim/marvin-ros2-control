...
namespace marvin_ros2_control
{
    ...
    private:
        ...
        static constexpr uint8_t kDefaultSlaveId = 0x01;
        ...
        static constexpr uint16_t kStatusWordRegister = 0x0050;
        ...
        bool status_word_initialized_ = false;
        uint16_t last_status_word_ = 0;
        uint8_t slave_id_ = kDefaultSlaveId;
